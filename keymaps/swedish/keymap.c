...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_LEFT] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, left_finished, left_reset, 150),
    [TD_RGHT] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, right_finished, right_reset, 150)
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QWERTY] = LAYOUT_CUSTOM(
     TD_EPS , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,                                          KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , SE_APOS, \
     ...
     KC_LCTL, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                                          KC_N   , KC_M   , KC_COMM, KC_DOT , SE_SLSH, SE_MINS, \
                       _______, KC_BSPC, RAISE  , KC_SPC , TD_MSE  , TD_GUI ,     TGLOW  , KC_BSPC, KC_ENT , LOWER  , SE_PLUS, SE_EQL ,                   \
  ...
  [_LOWER] = LAYOUT_CUSTOM(
     ...
     _______, _______, _______, _______, _______, _______,                                          _______, KC_1   , KC_2   , KC_3   , SE_LESS, SE_GRTR, \
  ...
  [_RAISE] = LAYOUT_CUSTOM(
     ...
     KC_ENT , _______, KC_UP  , _______, _______, _______,                                          RESET  , _______, _______, _______, KC_MUTE, SE_PIPE, \
